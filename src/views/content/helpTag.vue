        ...
        <div class="main-block">
          <el-form ref="searchForm" :model="searchForm" label-width="80px" :inline="true">
            <el-form-item label="标签：" prop="name">
              <el-input class="myInput" v-model="searchForm.name" placeholder="标签" clearable></el-input>
            </el-form-item>
...
<!--        @selection-change="handleSelectionChange"-->
        <el-table :data="tagList" border style="width: 100%" v-loading="listLoading" height="470">
<!--          <el-table-column-->
<!--            type="selection"-->
<!--            width="55">-->
<!--          </el-table-column>-->
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType" @close="dialogClose">
      ...
      >
        <el-form-item label="名称" prop="name">
          <el-input v-model="userForm.name" placeholder="标签名称"/>
        </el-form-item>
        <el-form-item label="所属用户" prop="moduleId">
          <el-select class="select" v-model="userForm.moduleId" clearable filterable placeholder="请选择">
            <el-option
              v-for="item in classifyList"
              :key="item.id"
              :label="item.label"
        ...
        <el-form-item label="排序字段" prop="orderNO">
          <el-input v-model="userForm.orderNO" placeholder="必须是数字"/>
        </el-form-item>
...
<script>
    ...
    import { getTags, getDetailById, addTags, editTags, delTags  } from '@/api/helpTag'
        ...
        data() {
            return {
                ...
                formRule: {
                    ...
                    orderNO:[{ required: true, message: '请输入排序字段', trigger: 'blur' }],
                    moduleId:[{ required: true, message: '请选择所属用户', trigger: 'blur' }]
                }
            }
        },
        methods: {
