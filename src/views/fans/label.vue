        ...
        <div class="main-block">
          <el-form ref="searchForm" :model="searchForm" label-width="80px" :inline="true">
            <el-form-item label="标签：" prop="name">
              <el-input class="myInput" v-model="searchForm.name" placeholder="粉丝标签" clearable></el-input>
            </el-form-item>
            <el-form-item>
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType" @close="dialogClose">
      ...
      >
        <el-form-item label="名称" prop="name">
          <el-input v-model="userForm.name" placeholder="粉丝标签名称"/>
        </el-form-item>
...
<script>
    ...
    import { getTags, getDetailById, addTags, editTags, delTags } from '@/api/fansTag'
