<template>
  <div class="contentBox">
    ...
    <div class="queryContent">
      ...
      <div class="table">
        <el-table :data="userList" border style="width: 100%" v-loading="listLoading" height="590" @selection-change="handleSelectionChange">
          ...
          <el-table-column align="center" label="供应商" width="140">
...
<script>
    ...
    import { supplier, productList,categorySecond } from '@/api/product'
